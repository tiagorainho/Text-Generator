...
def test(k:int, alpha:float, files:List[str], seed:int, generation_length:int, text_generations:Dict[str, str]):
...
if __name__ == '__main__':
    ...
    test(k, alpha, files, seed, generation_length, text_generations)
